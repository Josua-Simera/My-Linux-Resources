...
#########################################	Installing RaspiOS 64 bit (boot from USB M.2)	#########################################

Note: booting Raspberry Pi 4 B from USB SSD is a new development and require a bit of effort

0. Followed these guides: 	https://www.jeffgeerling.com/blog/2020/im-booting-my-raspberry-pi-4-usb-ssd
				https://www.tomshardware.com/how-to/boot-raspberry-pi-4-usb

1. Download and install latest beta of Raspi OS: https://www.raspberrypi.org/forums/viewtopic.php?t=275370

2. Flash on to MicroSD and SSD with Raspberry Pi Imager

3. On the MicroSD OS:
	sudo apt update
	sudo apt full-upgrade

4. 	sudo nano /etc/default/rpi-eeprom-update
	change "critical" to "stable"

5. Update to latest version of bootloader
	sudo rpi-eeprom-update -d -a

6. Reboot and check new version:
	vcgencmd bootloader_version

7. Connect SSD to MicroSD RPi and copy all .dat & .elf files from SD card /boot/ folder (easier to use mouse than below commands)
	sudo mkdir /mnt/usb
	mount /dev/sda1 /mnt/usb
	sudo cp /boot/*.elf /mnt/usb
	sudo cp /boot/*.dat /mnt/usb

8. Eject boot drive, and shutdown Pi. Remove SD Card, plug in SSD, and start up. SUCCESS!
